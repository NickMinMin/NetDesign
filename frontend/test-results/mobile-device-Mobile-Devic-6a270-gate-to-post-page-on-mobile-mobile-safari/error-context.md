...
- Name: mobile-device.spec.js >> Mobile Device: iOS Safari & Android Chrome >> should navigate to post page on mobile
- Location: tests\e2e\mobile-device.spec.js:104:3
