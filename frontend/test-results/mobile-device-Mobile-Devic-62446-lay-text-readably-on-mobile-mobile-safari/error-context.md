...
- Name: mobile-device.spec.js >> Mobile Device: iOS Safari & Android Chrome >> should display text readably on mobile
- Location: tests\e2e\mobile-device.spec.js:246:3
